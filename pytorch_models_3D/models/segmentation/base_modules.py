...
class SCSEModule(nn.Module):
    def __init__(self, in_channels, reduction=16):
        ...
        self.cSE = nn.Sequential(
            ...
            nn.Conv3d(in_channels=in_channels, out_channels=in_channels // reduction, kernel_size=1),
            nn.ReLU(inplace=True),
            nn.Conv3d(in_channels=in_channels // reduction, out_channels=in_channels, kernel_size=1),
            nn.Sigmoid(),
        )
        self.sSE = nn.Sequential(nn.Conv3d(in_channels=in_channels, out_channels=1, kernel_size=1), nn.Sigmoid())
